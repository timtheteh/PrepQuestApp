 ...
 * @param language - The current language ('Chinese', 'English', 'Afrikaans', 'Indonesian', 'Malay', 'Czech', 'Dutch', 'German', 'Spanish', 'French', 'Italian', 'Swahili', 'Hungarian', 'Norwegian', 'Polish', or 'Portuguese')
