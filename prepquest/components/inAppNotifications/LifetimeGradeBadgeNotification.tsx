...
interface LifetimeGradeBadgeNotificationProps {
  badgeName: string;
  badgeSubtext: string;
  visible: boolean;
  onDismiss: () => void;
...
export const LifetimeGradeBadgeNotification: React.FC<LifetimeGradeBadgeNotificationProps> = ({ 
  badgeName,
  badgeSubtext,
  visible,
  onDismiss,
  ...
  useEffect(() => {
    ...
    if (visible) {
      console.log('🎖️ Showing lifetime grade badge notification');
      // Show notification
      Animated.parallel([
