...
export const stringsOnboarding = {
  English: {
    ...
    invalidTextInput: 'Invalid text input found! Make sure that your input is comma-separated.',
  ...
  Chinese: {
    ...
    invalidTextInput: '发现无效的文本输入！请确保您的输入是逗号分隔的。',
  ...
  Malay: {
    ...
    adultLearner: 'Pembelajar Dewasa',
    middleSchool: 'Sekolah Menengah Rendah',
    elementarySchool: 'Sekolah Rendah',
    // Interview types
    technical: 'Teknikal',
    ...
    invalidTextInput: 'Input teks tidak sah ditemui! Pastikan input anda dipisahkan dengan koma.',
  },
  Hindi: {
    skip: 'छोड़ें',
    next: 'अगला',
  ...
  French: {
    ...
    invalidTextInput: 'Saisie de texte invalide trouvée ! Assurez-vous que votre saisie est séparée par des virgules.',
  },
  Japanese: {
    skip: 'スキップ',
    next: '次へ',
  ...
  Spanish: {
    ...
    invalidTextInput: '¡Entrada de texto inválida encontrada! Asegúrese de que su entrada esté separada por comas.',
  },
  German: {
    skip: 'Überspringen',
    next: 'Weiter',
    ...
    graduate: 'Master',
    adultLearner: 'Erwachsenenlerner',
    middleSchool: 'Realschule',
    ...
    invalidTextInput: 'Ungültige Texteingabe gefunden! Stellen Sie sicher, dass Ihre Eingabe durch Kommas getrennt ist.',
  },
  Portuguese: {
    skip: 'Pular',
    next: 'Próximo',
    ...
    adultLearner: 'Estudante Adulto',
    middleSchool: 'Ensino Fundamental II',
    elementarySchool: 'Ensino Fundamental I',
    // Interview types
    technical: 'Técnico',
    behavioral: 'Comportamental',
    ...
    resendCode: 'Reenviar código',
    resendingCode: 'Reenviando...',
    invalidTextInput: 'Entrada de texto inválida encontrada! Certifique-se de que sua entrada está separada por vírgulas.',
  },
  Italian: {
    skip: 'Salta',
    next: 'Avanti',
    ...
    adultLearner: 'Studente Adulto',
    middleSchool: 'Scuola Media',
    elementarySchool: 'Scuola Elementare',
    // Interview types
    technical: 'Tecnico',
  ...
  Russian: {
    ...
    adultLearner: 'Взрослый учащийся',
  ...
  Arabic: {
    ...
    adultLearner: 'المتعلم البالغ',
    middleSchool: 'المدرسة الإعدادية',
    elementarySchool: 'المدرسة الابتدائية',
    // Interview types
    technical: 'التقني',
    behavioral: 'السلوكي',
    ...
    invalidTextInput: 'تم العثور على إدخال نص غير صالح! تأكد من أن إدخالك مفصول بفواصل.',
  },
  Indonesian: {
    skip: 'Lewati',
    next: 'Selanjutnya',
  ...
  Turkish: {
    ...
    adultLearner: 'Yetişkin Öğrenci',
    middleSchool: 'Ortaokul',
    elementarySchool: 'İlkokul',
    // Interview types
    technical: 'Teknik',
  ...
  Dutch: {
    ...
    graduate: 'Master',
    adultLearner: 'Volwassen Lerner',
    middleSchool: 'Middelbare School',
    ...
    invalidTextInput: 'Ongeldige tekstinvoer gevonden! Zorg ervoor dat uw invoer door komma\'s wordt gescheiden.',
  ...
  Polish: {
    ...
    elementarySchool: 'Szkoła Podstawowa',
    // Interview types
    ...
    invalidTextInput: 'Znaleziono nieprawidłowe wprowadzenie tekstu! Upewnij się, że wprowadzenie jest oddzielone przecinkami.',
  ...
  Swedish: {
    ...
    invalidTextInput: 'Ogiltig textinmatning hittades! Se till att din inmatning är kommaavgränsad.',
  ...
  Czech: {
    ...
    adultLearner: 'Dospělý student',
    middleSchool: 'Základní škola',
    ...
    invalidTextInput: 'Nalezen neplatný textový vstup! Ujistěte se, že váš vstup je oddělen čárkami.',
  ...
  Hebrew: {
    ...
    elementarySchool: 'בית ספר יסודי',
    // Interview types
    technical: 'טכני',
    behavioral: 'התנהגותי',
    caseStudy: 'מחקר מקרה',
  ...
  Tagalog: {
    ...
    graduate: 'Master',
    adultLearner: 'Matandang Mag-aaral',
    middleSchool: 'Gitnang Paaralan',
    elementarySchool: 'Elementarya',
    // Interview types
    technical: 'Teknikal',
    behavioral: 'Asal',
    ...
    invalidTextInput: 'Natagpuan ang hindi wastong text input! Siguraduhing ang iyong input ay pinaghihiwalay ng kuwit.',
  ...
  Tamil: {
    ...
    graduate: 'முதுகலை',
    adultLearner: 'வயது வந்த மாணவர்',
    middleSchool: 'இடைநிலைப் பள்ளி',
    elementarySchool: 'தொடக்கப் பள்ளி',
    // Interview types
  ...
  Bengali: {
    ...
    adultLearner: 'প্রাপ্তবয়স্ক শিক্ষার্থী',
    middleSchool: 'মাধ্যমিক বিদ্যালয়',
    elementarySchool: 'প্রাথমিক বিদ্যালয়',
    // Interview types
  ...
  Romanian: {
    ...
    middleSchool: 'Școala Gimnazială',
    elementarySchool: 'Școala Primară',
    // Interview types
    technical: 'Tehnic',
    behavioral: 'Comportamental',
    ...
    invalidTextInput: 'Intrare de text invalidă găsită! Asigurați-vă că intrarea dvs. este separată prin virgule.',
  ...
  Hungarian: {
    ...
    middleSchool: 'Általános Iskola',
    elementarySchool: 'Általános Iskola',
    // Interview types
    technical: 'Műszaki',
    ...
    invalidTextInput: 'Érvénytelen szövegbevitel találva! Győződjön meg arról, hogy a bevitel vesszővel elválasztott.',
  ...
  Farsi: {
    ...
    adultLearner: 'یادگیرنده بزرگسال',
    middleSchool: 'راهنمایی',
    elementarySchool: 'ابتدایی',
    // Interview types
    technical: 'فنی',
    behavioral: 'رفتاری',
  ...
  Swahili: {
    ...
    adultLearner: 'Mwanafunzi Mzima',
    middleSchool: 'Shule ya Sekondari',
    elementarySchool: 'Shule ya Msingi',
    // Interview types
    technical: 'Kitaalamu',
    behavioral: 'Tabia',
    ...
    invalidTextInput: 'Ingizo la maandishi lisilo sahihi limepatikana! Hakikisha kuwa ingizo lako limegawanywa kwa koma.',
  ...
  Afrikaans: {
    ...
    undergraduate: 'Universiteit',
    graduate: 'Nagraadse',
    adultLearner: 'Volwassene Leerder',
    middleSchool: 'Hoërskool',
    elementarySchool: 'Laerskool',
    // Interview types
    technical: 'Tegnies',
    behavioral: 'Gedragsmatig',
    ...
    invalidTextInput: 'Ongeldige teksinvoer gevind! Maak seker dat jou invoer deur kommas geskei is.',
  ...
  Finnish: {
    ...
    graduate: 'Maisteri',
    adultLearner: 'Aikuisoppija',
    middleSchool: 'Peruskoulu',
    elementarySchool: 'Peruskoulu',
    // Interview types
    technical: 'Tekninen',
    ...
    invalidTextInput: 'Virheellinen tekstisyöte löydetty! Varmista, että syöte on pilkuilla erotettu.',
  ...
  Norwegian: {
    ...
    undergraduate: 'Universitet',
    graduate: 'Mastergrad',
    adultLearner: 'Voksenlæring',
    middleSchool: 'Videregående skole',
    elementarySchool: 'Grunnskole',
    // Interview types
    technical: 'Teknisk',
    ...
    invalidTextInput: 'Ugyldig tekstinndata funnet! Sørg for at inndataen din er komma-separert.',
  ...
  Danish: {
    ...
    adultLearner: 'Voksenlæring',
    middleSchool: 'Gymnasium',
    elementarySchool: 'Folkeskole',
    // Interview types
    technical: 'Teknisk',
