...
import { getFavoritedDecks, Deck, deleteMultipleDecks, unfavoriteMultipleDecks, updateDeckFavoriteStatus, checkDatabaseReady } from '@/db/tables/decks';
import { getFavoritedFolders, Folder, deleteMultipleFolders, createNewFavoritedFolder, unfavoriteMultipleFolders, updateFolderFavoriteStatus } from '@/db/tables/folders';
