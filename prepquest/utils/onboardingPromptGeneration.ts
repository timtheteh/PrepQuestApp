...
export const generateOnboardingPrompt = async (params: {
  ...
  if (modeStr === 'interview' && language === 'Norwegian') {
    ...
    if (interviewOptionalQuestion1 && interviewOptionalQuestion1.trim() !== '') {
      prompt += `Erfaringsnivået for denne stillingen er ${interviewOptionalQuestion1}.\n`
    }
    if (interviewOptionalQuestion2 && interviewOptionalQuestion2.trim() !== '') {
      prompt += `Selskapet jeg forbereder meg til intervjuet for er ${interviewOptionalQuestion2}.\n`
    }
    if (interviewOptionalQuestion3 && interviewOptionalQuestion3.trim() !== '') {
  ...
  if (modeStr === 'study' && language === 'Norwegian') {
    prompt += `Jeg studerer for ${studyMandatoryQuestion1} og min utdanningsnivå er ${studyMandatoryQuestion2}.\n`
    if (studyOptionalQuestion1 && studyOptionalQuestion1.trim() !== '') {
      prompt += `Eksamenen jeg forbereder meg til er ${studyOptionalQuestion1}.\n`
    }
    if (studyOptionalQuestion2 && studyOptionalQuestion2.trim() !== '') {
      prompt += `Temaene jeg vil fokusere på er ${studyOptionalQuestion2}.\n`
    }
  }
  ...
  if (modeStr === 'interview' && language === 'Polish') {
    ...
    if (interviewOptionalQuestion1 && interviewOptionalQuestion1.trim() !== '') {
      prompt += `Poziom doświadczenia dla tego stanowiska to ${interviewOptionalQuestion1}.\n`
    }
    if (interviewOptionalQuestion2 && interviewOptionalQuestion2.trim() !== '') {
      prompt += `Firma, do której przygotowuję się na rozmowę, to ${interviewOptionalQuestion2}.\n`
    }
    if (interviewOptionalQuestion3 && interviewOptionalQuestion3.trim() !== '') {
  ...
  if (modeStr === 'study' && language === 'Polish') {
    prompt += `Uczę się ${studyMandatoryQuestion1} i mój poziom edukacji to ${studyMandatoryQuestion2}.\n`
    if (studyOptionalQuestion1 && studyOptionalQuestion1.trim() !== '') {
      prompt += `Egzamin, do którego się przygotowuję, to ${studyOptionalQuestion1}.\n`
    }
    if (studyOptionalQuestion2 && studyOptionalQuestion2.trim() !== '') {
      prompt += `Tematy, na których chciałbym się skupić, to ${studyOptionalQuestion2}.\n`
    }
  }
  ...
  if (modeStr === 'interview' && language === 'Portuguese') {
    ...
    if (interviewOptionalQuestion1 && interviewOptionalQuestion1.trim() !== '') {
      prompt += `O nível de experiência para esta posição é ${interviewOptionalQuestion1}.\n`
    }
    if (interviewOptionalQuestion2 && interviewOptionalQuestion2.trim() !== '') {
      prompt += `A empresa para a qual estou me preparando para a entrevista é ${interviewOptionalQuestion2}.\n`
    }
    if (interviewOptionalQuestion3 && interviewOptionalQuestion3.trim() !== '') {
  ...
  if (modeStr === 'study' && language === 'Portuguese') {
    prompt += `Estou estudando para ${studyMandatoryQuestion1} e meu nível educacional é ${studyMandatoryQuestion2}.\n`
    if (studyOptionalQuestion1 && studyOptionalQuestion1.trim() !== '') {
      prompt += `O exame para o qual estou me preparando é ${studyOptionalQuestion1}.\n`
    }
    if (studyOptionalQuestion2 && studyOptionalQuestion2.trim() !== '') {
      prompt += `Os tópicos em que gostaria de focar são ${studyOptionalQuestion2}.\n`
    }
  }
  ...
  if (modeStr === 'interview' && language === 'Romanian') {
    ...
    if (interviewOptionalQuestion1 && interviewOptionalQuestion1.trim() !== '') {
      prompt += `Nivelul de experiență pentru această poziție este ${interviewOptionalQuestion1}.\n`
    }
    if (interviewOptionalQuestion2 && interviewOptionalQuestion2.trim() !== '') {
      prompt += `Compania pentru care mă pregătesc pentru interviu este ${interviewOptionalQuestion2}.\n`
    }
    if (interviewOptionalQuestion3 && interviewOptionalQuestion3.trim() !== '') {
  ...
  if (modeStr === 'study' && language === 'Romanian') {
    prompt += `Studiez pentru ${studyMandatoryQuestion1} și nivelul meu de educație este ${studyMandatoryQuestion2}.\n`
    if (studyOptionalQuestion1 && studyOptionalQuestion1.trim() !== '') {
      prompt += `Examenul pentru care mă pregătesc este ${studyOptionalQuestion1}.\n`
    }
    if (studyOptionalQuestion2 && studyOptionalQuestion2.trim() !== '') {
      prompt += `Subiectele pe care aș dori să mă concentrez sunt ${studyOptionalQuestion2}.\n`
    }
  }
  ...
  if (modeStr === 'interview' && language === 'Finnish') {
    ...
    if (interviewOptionalQuestion1 && interviewOptionalQuestion1.trim() !== '') {
      prompt += `Tämän tehtävän kokemustaso on ${interviewOptionalQuestion1}.\n`
    }
    if (interviewOptionalQuestion2 && interviewOptionalQuestion2.trim() !== '') {
      prompt += `Yritys, jolle valmistan haastattelua, on ${interviewOptionalQuestion2}.\n`
    }
    if (interviewOptionalQuestion3 && interviewOptionalQuestion3.trim() !== '') {
  ...
  if (modeStr === 'study' && language === 'Finnish') {
    prompt += `Opiskelen ${studyMandatoryQuestion1} -aihetta ja koulutustasoni on ${studyMandatoryQuestion2}.\n`
    if (studyOptionalQuestion1 && studyOptionalQuestion1.trim() !== '') {
      prompt += `Kokeeseen, johon valmistan, on ${studyOptionalQuestion1}.\n`
    }
    if (studyOptionalQuestion2 && studyOptionalQuestion2.trim() !== '') {
      prompt += `Aiheet, joihin haluaisin keskittyä, ovat ${studyOptionalQuestion2}.\n`
    }
  }
  ...
  if (modeStr === 'interview' && language === 'Swedish') {
    ...
    if (interviewOptionalQuestion1 && interviewOptionalQuestion1.trim() !== '') {
      prompt += `Erfarenhetsnivån för denna position är ${interviewOptionalQuestion1}.\n`
    }
    if (interviewOptionalQuestion2 && interviewOptionalQuestion2.trim() !== '') {
      prompt += `Företaget jag förbereder mig för intervjun för är ${interviewOptionalQuestion2}.\n`
    }
    if (interviewOptionalQuestion3 && interviewOptionalQuestion3.trim() !== '') {
  ...
  if (modeStr === 'study' && language === 'Swedish') {
    prompt += `Jag studerar för ${studyMandatoryQuestion1} och min utbildningsnivå är ${studyMandatoryQuestion2}.\n`
    if (studyOptionalQuestion1 && studyOptionalQuestion1.trim() !== '') {
      prompt += `Examen jag förbereder mig för är ${studyOptionalQuestion1}.\n`
    }
    if (studyOptionalQuestion2 && studyOptionalQuestion2.trim() !== '') {
      prompt += `Ämnena jag skulle vilja fokusera på är ${studyOptionalQuestion2}.\n`
    }
  }
  ...
  if (modeStr === 'interview' && language === 'Tagalog') {
    ...
    if (interviewOptionalQuestion1 && interviewOptionalQuestion1.trim() !== '') {
      prompt += `Ang antas ng karanasan para sa posisyon na ito ay ${interviewOptionalQuestion1}.\n`
    }
    if (interviewOptionalQuestion2 && interviewOptionalQuestion2.trim() !== '') {
      prompt += `Ang kumpanyang aking inihahanda para sa interview ay ${interviewOptionalQuestion2}.\n`
    }
    if (interviewOptionalQuestion3 && interviewOptionalQuestion3.trim() !== '') {
      prompt += `Ang mga paksa na nais kong pagtuunan ng pansin ay ${interviewOptionalQuestion3}.\n`
    }
  }

  if (modeStr === 'study' && language === 'Tagalog') {
    prompt += `Nag-aaral ako para sa ${studyMandatoryQuestion1} at ang aking antas ng edukasyon ay ${studyMandatoryQuestion2}.\n`
    if (studyOptionalQuestion1 && studyOptionalQuestion1.trim() !== '') {
      prompt += `Ang pagsusulit na aking inihahanda ay ${studyOptionalQuestion1}.\n`
    }
    if (studyOptionalQuestion2 && studyOptionalQuestion2.trim() !== '') {
      prompt += `Ang mga paksa na nais kong pagtuunan ng pansin ay ${studyOptionalQuestion2}.\n`
    }
  }
  ...
  if (distributionOfFlashcards) {   
    ...
    if (language === 'Tagalog') {
      for (const [flashcardType, numQuestions] of Object.entries(distributionOfFlashcards)) {
        ...
        prompt += `${promptAndDataTagalog[flashcardType as keyof typeof promptAndDataTagalog].prompt}\n`
      }
    }
  }
  ...
  if (language === 'Norwegian' && modeStr === 'interview') {
  ...
  if (language === 'Norwegian' && modeStr === 'study') {
  ...
  if (language === 'Polish' && modeStr === 'interview') {
  ...
  if (language === 'Polish' && modeStr === 'study') {
  ...
  if (language === 'Portuguese' && modeStr === 'interview') { 
  ...
  if (language === 'Portuguese' && modeStr === 'study') { 
  ...
  if (language === 'Romanian' && modeStr === 'interview') { 
  ...
  if (language === 'Romanian' && modeStr === 'study') { 
  ...
  if (language === 'Finnish' && modeStr === 'interview') { 
  ...
  if (language === 'Finnish' && modeStr === 'study') { 
  ...
  if (language === 'Swedish' && modeStr === 'interview') { 
  ...
  if (language === 'Swedish' && modeStr === 'study') { 
  ...
  if (language === 'Tagalog' && modeStr === 'interview') { 
  ...
  if (language === 'Tagalog' && modeStr === 'study') { 
