...
export async function checkAndAwardWelcomeBadges(badgeSubtext: '1st Deck Studied' | '1st Deck Quizzed' | '1st Feedback by AI' | '1st Gen-AI Deck' | '1st File-Upload Deck' | '1st Youtube Deck'): Promise<WelcomeBadgeAward | null> {
  try {
    const userID = await getCurrentUserID();
