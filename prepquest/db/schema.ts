...
export function initializeDatabase(db: SQLite.SQLiteDatabase) {
  ...
  db.execAsync(`
    DROP TABLE IF EXISTS AIFlashcards;
    DROP TABLE IF EXISTS AIDecks;
    DROP TABLE IF EXISTS userFormEntries;
  ...
  `).then(() => {
    ...
    return db.execAsync(`
      ...
      CREATE TABLE IF NOT EXISTS decks (
        ...
        studySubjects TEXT, -- Store as JSON array: ["subject1", "subject2", "subject3"]
