const promptAndData = {
    ...
    {"prompt": "For 'Recall Text Question to MCQ Answer', give your output in json format like this: {'flashcardType': 'Recall Text Question to MCQ Answer', 'question': 'Which HTTP status code indicates that a request has succeeded?', 'answer': [{'option': '404', 'ans': false}, {'option': '500', 'ans': false}, {'option': '200', 'ans': true}, {'option': '403', 'ans': false}]}",
      "questionType": "text",
      "answerType": "mcq",
      "cognitiveQnType": "Recall"
    },
    ...
    {"prompt": "For 'Recall Cloze Question to Text Answer', give your output in json format like this: {'flashcardType': 'Recall Cloze Question to Text Answer', 'question': 'In JavaScript, the <blank> keyword is used to declare a variable with block scope and prevent reassignment.', 'answer': 'const'}",
      "questionType": "text",
      "answerType": "text",
      "cognitiveQnType": "Recall"
    },
    ...
    {"prompt": "For 'Comprehension Text Question to Voice Answer', give your output in json format like this: {'flashcardType': 'Comprehension Text Question to Voice Answer', 'question': 'How does a load balancer improve the reliability and scalability of a web application?', 'answer': ''}",
      "questionType": "text",       
      "answerType": "voice",
      "cognitiveQnType": "Comprehension"
    },
...
const promptAndDataChinese = {
    // Recall, Text to Text
    "Recall Text Question to Text Answer":
    {"prompt": "至于 'Recall Text Question to Text Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Recall Text Question to Text Answer', 'question': 'DNS（域名系统）服务器的主要作用是什么？', 'answer': 'DNS 服务器将人类可读的域名（例如 www.example.com）转换为计算机在网络中相互识别所使用的 IP 地址。'}",
      "questionType": "text",
      "answerType": "text",
      "cognitiveQnType": "Recall"
    },
    // Recall, Text to MCQ
    "Recall Text Question to MCQ Answer":
    {"prompt": "至于 'Recall Text Question to MCQ Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Recall Text Question to MCQ Answer', 'question': '哪个 HTTP 状态码表示请求已成功？', 'answer': [{'option': '404', 'ans': false}, {'option': '500', 'ans': false}, {'option': '200', 'ans': true}, {'option': '403', 'ans': false}]}",
      "questionType": "text",
      "answerType": "mcq",
      "cognitiveQnType": "Recall"
    },
    // Recall, Cloze to Text
    "Recall Cloze Question to Text Answer":
    {"prompt": "至于 'Recall Cloze Question to Text Answer', 请以如下 JSON 格式输出结果：{'flashcardType': 'Recall Cloze Question to Text Answer', 'question': '在 JavaScript 中，关键字 <blank> 用于声明具有块作用域且不可重新赋值的变量。', 'answer': 'const'}",
      "questionType": "text",
      "answerType": "text",
      "cognitiveQnType": "Recall"
    },
    // Recall, Cloze to MCQ
    "Recall Cloze Question to MCQ Answer":
    {"prompt": "至于 'Recall Cloze Question to MCQ Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Recall Cloze Question to MCQ Answer', 'question': '在 SQL 中，<blank> 命令用于在不记录每一行删除操作的情况下删除表中的所有记录。', 'answer': [{'option': 'DELETE', 'ans': false}, {'option': 'TRUNCATE', 'ans': true}, {'option': 'REMOVE', 'ans': false}, {'option': 'DROP', 'ans': false}]}",
      "questionType": "text",
      "answerType": "mcq",
      "cognitiveQnType": "Recall"
    },
    // Comprehension, Text to Text
    "Comprehension Text Question to Text Answer":
    {"prompt": "至于 'Comprehension Text Question to Text Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Comprehension Text Question to Text Answer', 'question': '请解释在编程中浅拷贝和深拷贝之间的区别。', 'answer': '浅拷贝只复制对象的顶层引用，这意味着嵌套的对象仍然是共享的。深拷贝会递归地复制所有嵌套的对象，从而创建出与原始结构完全独立的副本。'}",
      "questionType": "text",
      "answerType": "text",
      "cognitiveQnType": "Comprehension"
    },
    // Comprehension, Text to MCQ
    "Comprehension Text Question to MCQ Answer":
    {"prompt": "至于 'Comprehension Text Question to MCQ Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Comprehension Text Question to MCQ Answer', 'question': '以下哪项最能解释 HTTP 和 HTTPS 之间的区别？', 'answer': [{'option': 'HTTPS 使用 80 端口，而 HTTP 使用 443 端口。', 'ans': false}, {'option': 'HTTP 在传输过程中加密数据，而 HTTPS 不加密。', 'ans': false}, {'option': 'HTTP 和 HTTPS 之间没有实质性区别。', 'ans': false}, {'option': 'HTTPS 通过 SSL/TLS 添加加密层来保护数据传输，而 HTTP 不加密。', 'ans': true}]}",
      "questionType": "text",
      "answerType": "mcq",
      "cognitiveQnType": "Comprehension"
    },
    // Comprehension, Text to Voice
    "Comprehension Text Question to Voice Answer":
    {"prompt": "至于 'Comprehension Text Question to Voice Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Comprehension Text Question to Voice Answer', 'question': '负载均衡器如何提高 Web 应用程序的可靠性和可扩展性？', 'answer': ''}",
      "questionType": "text",       
      "answerType": "voice",
      "cognitiveQnType": "Comprehension"
    },
    // Application, Text to Text
    "Application Text Question to Text Answer":
    {"prompt": "至于 'Application Text Question to Text Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Application Text Question to Text Answer', 'question': '您需要将用户会话数据暂时存储在后台系统中。您会选择哪种数据结构或存储方法，并解释原因。', 'answer': '使用 Redis 等内存键值存储是一个合适的选择，因为它允许快速读写访问，并支持会话数据的自动过期，这非常适合临时会话管理。'}",
      "questionType": "text",
      "answerType": "text",
      "cognitiveQnType": "Application"
    },
    // Application, Text to MCQ
    "Application Text Question to MCQ Answer":
    {"prompt": "至于 'Application Text Question to MCQ Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Application Text Question to MCQ Answer', 'question': '您正在设计一个收集敏感用户信息的网页表单。以下哪项操作最有助于在数据传输过程中增强安全性？', 'answer': [{'option': '使用 HTTPS 通过 POST 请求提交表单。', 'ans': true}, {'option': '使用 GET 请求提交表单以提高速度。', 'ans': false}, {'option': '压缩 HTML 以使源代码更难读取。', 'ans': false}, {'option': '将数据存储在 cookies 中以快速访问。', 'ans': false}]}",
      "questionType": "text",
      "answerType": "mcq",
      "cognitiveQnType": "Application"
    },
    // Application, Text to Voice
    "Application Text Question to Voice Answer":
    {"prompt": "至于 'Application Text Question to Voice Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Application Text Question to Voice Answer', 'question': '您被分配了一个 REST API，它在负载下经历了高延迟。您会采取哪些实际步骤来识别和解决这个问题？', 'answer': ''}",
      "questionType": "text",
      "answerType": "voice",
      "cognitiveQnType": "Application"
    },
    // Analysis, Text to Text
    "Analysis Text Question to Text Answer":
    {"prompt": "至于 'Analysis Text Question to Text Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Analysis Text Question to Text Answer', 'question': 'A/B 测试显示，新的结账页面虽然用户更快地到达支付步骤，但完成的购买数量却更少。您会如何分析这一结果？', 'answer': '我会详细分析用户旅程，重点关注用户在新流程中在哪里流失。我会分析会话记录、漏斗数据和表单放弃率。可能是因为新流程引入了可用性问题、混淆或信任问题。我会比较错误率、字段验证行为和加载时间。我还会查看定性反馈或调查以了解用户感知。'}",
      "questionType": "text",
      "answerType": "text",
      "cognitiveQnType": "Analysis"
    },
    ...
    "Analysis Text Question to MCQ Answer":
    {"prompt": "至于 'Analysis Text Question to MCQ Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Analysis Text Question to MCQ Answer', 'question': '你的团队正在调查为何新部署的功能导致页面加载时间显著增加。分析过程中最合理的下一步是什么？', 'answer': [{'option': '立即回滚部署。', 'ans': false}, {'option': '切换到另一个前端框架。', 'ans': false}, {'option': '分析前端和后端的性能，定位具体的瓶颈。', 'ans': true}, {'option': '增加服务器容量并观察结果。', 'ans': false}]}",
        "questionType": "text",
        "answerType": "mcq",
        "cognitiveQnType": "Analysis"
    },
    // Analysis, Text to Voice
    "Analysis Text Question to Voice Answer":
    {"prompt": "至于 'Analysis Text Question to Voice Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Analysis Text Question to Voice Answer', 'question': '您注意到用户在高峰时段访问您的应用程序时经常超时。您会采取哪些步骤来识别问题的根本原因？', 'answer': ''}",
      "questionType": "text",
      "answerType": "voice",
      "cognitiveQnType": "Analysis"
    },
    // Synthesis, Text to Text
    "Synthesis Text Question to Text Answer":
    {"prompt": "至于 'Synthesis Text Question to Text Answer', 请以如下 JSON 格式输出结果：{'flashcardType': 'Synthesis Text Question to Text Answer', 'question': '设计一个可扩展的通知系统，能够向数百万用户发送电子邮件、短信和推送通知。您会包括哪些关键组件，以及它们如何交互？', 'answer': '我会设计一个系统，使用消息队列处理高吞吐量，一个通知服务处理消息并通过适当通道（电子邮件、短信、推送）发送。该系统会为每种通知类型使用微服务，一个数据库跟踪交付状态，以及速率限制以防止过载。负载均衡器和自动伸缩组将确保可用性和可扩展性。'}",
      "questionType": "text",
      "answerType": "text",
      "cognitiveQnType": "Synthesis"
    },
    // Synthesis, Text to MCQ
    "Synthesis Text Question to MCQ Answer":
    {"prompt": "至于 'Synthesis Text Question to MCQ Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Synthesis Text Question to MCQ Answer', 'question': '您需要设计一个系统，从多个传感器收集实时数据并提供分析仪表板。哪种设计选择最能平衡可扩展性、可靠性和延迟？', 'answer': [{'option': '使用集中式数据库，所有传感器数据同步写入。', 'ans': false}, {'option': '在每个传感器上本地存储数据，并在一天结束时批量上传。', 'ans': false}, {'option': '使用客户端处理所有分析以减少服务器负载。', 'ans': false}, {'option': '实现分布式消息队列，使用微服务异步处理数据。', 'ans': true}]}",
      "questionType": "text",
      "answerType": "mcq",
      "cognitiveQnType": "Synthesis"
    },
    // Synthesis, Text to Voice
    "Synthesis Text Question to Voice Answer":
    {"prompt": "至于 'Synthesis Text Question to Voice Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Synthesis Text Question to Voice Answer', 'question': '设计一个系统，能够处理数百万用户的实时聊天，确保消息传递、可扩展性和数据一致性。描述关键组件及其交互。', 'answer': ''}",
      "questionType": "text",
      "answerType": "voice",
      "cognitiveQnType": "Synthesis"
    },
    // Evaluation, Text to Text
    "Evaluation Text Question to Text Answer":
    {"prompt": "至于 'Evaluation Text Question to Text Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Evaluation Text Question to Text Answer', 'question': '您正在为高流量电子商务平台选择 SQL 和 NoSQL 数据库。您会选择哪个，并解释原因？', 'answer': '对于电子商务平台，SQL 数据库通常是更好的选择，因为需要强一致性、复杂交易和结构化关系数据（如订单、库存和用户）。然而，如果可扩展性和灵活性更重要（例如处理产品评论或会话数据），可以在多语言架构中集成 MongoDB 或 DynamoDB 等 NoSQL 解决方案。'}",
      "questionType": "text",
      "answerType": "text",
      "cognitiveQnType": "Evaluation"
    },
    ...
    // Evaluation, Text to Voice
    "Evaluation Text Question to Voice Answer":
    {"prompt": "至于 'Evaluation Text Question to Voice Answer', 请以如下 JSON 格式输出结果：{'flashcardType': 'Evaluation Text Question to Voice Answer', 'question': '您的团队正在决定是构建内部功能还是使用第三方 SaaS 解决方案。您会评估哪些因素来做出推荐，以及什么因素会引导您的最终决策？', 'answer': ''}",
      "questionType": "text",
      "answerType": "voice",
      "cognitiveQnType": "Evaluation"
    },
    // Problem-Solving, Text to Text
    "Problem-Solving Text Question to Text Answer":
    {"prompt": "至于 'Problem-Solving Text Question to Text Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Problem-Solving Text Question to Text Answer', 'question': '您正在构建一个搜索功能，需要快速返回相关结果，即使数据集不断增长。您会如何设计这个系统以保持快速性能？', 'answer': '我会开始使用全文本搜索引擎（如 Elasticsearch）或数据库索引策略来索引可搜索字段。为了提高性能，我会分页结果，使用缓存处理频繁查询，并考虑非规范化数据以更快地读取。此外，我会监控查询时间并根据需要调整索引或分片数据。'}",
      "questionType": "text",
      "answerType": "text",
      "cognitiveQnType": "Problem-Solving"
    },
    // Problem-Solving, Text to MCQ
    "Problem-Solving Text Question to MCQ Answer":
    {"prompt": "至于 'Problem-Solving Text Question to MCQ Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Problem-Solving Text Question to MCQ Answer', 'question': '您的移动应用程序随机崩溃，但您无法在设备上重现该问题。诊断问题的最佳第一步是什么？', 'answer': [{'option': '要求用户删除并重新安装应用程序。', 'ans': false}, {'option': '推送紧急更新，但只进行最小更改。', 'ans': false}, {'option': '检查崩溃日志和分析工具（如 Firebase Crashlytics）以识别模式。', 'ans': true}, {'option': '禁用功能，直到崩溃停止。', 'ans': false}]}",
      "questionType": "text",
      "answerType": "mcq",
      "cognitiveQnType": "Problem-Solving"
    },
    // Problem-Solving, Text to Voice
    "Problem-Solving Text Question to Voice Answer":
    {"prompt": "至于 'Problem-Solving Text Question to Voice Answer', 请以如下 JSON 格式输出结果： {'flashcardType': 'Problem-Solving Text Question to Voice Answer', 'question': '您的 Web 应用程序中的一个关键功能在高流量下间歇性失败，但日志中没有错误。您会如何识别和解决这个问题？', 'answer': ''}",
      "questionType": "text",
      "answerType": "voice",
      "cognitiveQnType": "Problem-Solving"
    }
...
function getFlashcardTypeWeightsForCognitiveType(
  ...
  cognitiveType: string
    ...
    const applicationWeights = {
        "Application Text Question to TextAnswer": 1,
        "Application Text Question to MCQ Answer": 0,
        "Application Text Question to Voice Answer": 0,
    }
    if (isMcqEnabled && isVoiceRecordedEnabled) {
        applicationWeights["Application Text Question to TextAnswer"] = 0.25
    ...
    if (isMcqEnabled && !isVoiceRecordedEnabled) {
        applicationWeights["Application Text Question to TextAnswer"] = 0.5
